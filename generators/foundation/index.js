...
module.exports = class extends yeoman {
    ...
    _copyProjectItems() {
        this.settings.ProjectPath = "Foundation/" + this.settings.ProjectName + "/code"
    ...
    _copySerializationItems() {
        mkdir.sync("Foundation/" + this.settings.ProjectName + "/serialization");
        this.fs.copyTpl(this.templatePath('_serialization.config'), this.destinationPath("Foundation/" + this.settings.ProjectName + "/code/App_Config/Include/" + this.settings.ProjectName+ "/serialization.config"), this.templatedata);
    }
    ...
    writing() {
           ...
           const scriptParameters = "-SolutionFile '" + this.destinationPath(SolutionFile) + "' -Name " + this.settings.ProjectName + " -Type Foundation -ProjectPath '" + this.settings.ProjectPath + "'";
